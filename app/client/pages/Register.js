    ...
    const handleSubmit = async (e)=>{
        ...
        if(password !== confPass){
            ...
            try{
                ...
                if(res.data.message === "User added to the database"){
                    signIn("credentials", {
                        email, password, callbackUrl: `${window.location.origin}/Fabric`, redirect: false }
                    ...
                    setError(()=>{return("Something went wrong")})
                }
            }catch(err){
                console.log(err)
            }
